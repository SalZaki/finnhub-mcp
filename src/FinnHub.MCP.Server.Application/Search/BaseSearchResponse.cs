...
public abstract class BaseSearchResponse
{
    ...
    /// <summary>
    /// Gets the unique identifier for the search query that produced this response.
    /// </summary>
    /// <value>
    /// A short, opaque correlation token (typically a truncated GUID) generated by
    /// the query builder. Pairs with the <see cref="Query"/> string to let logs
    /// and clients trace a single response back to the request that produced it.
